...
interval = sys.argv[3] if len(sys.argv) > 3 else '60' #default es 60min
...
urls = {
    "bybit": f"https://api.bybit.com/v5/market/kline?category=inverse&symbol={symbol}&interval={interval}&limit={limit}",
